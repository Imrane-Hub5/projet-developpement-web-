    ...
    <header>
        <nav>
            <ul>
                ...
                <li><a href="politique-cookies.php">Politique des cookies</a></li>
            </ul>
        </nav>
    </header>
    ...
    <main>
        <section class="container">
            ...
            <div class="legal-content">
                ...
                <h2>Cookies</h2>
                <p>Ce site utilise des cookies pour améliorer l'expérience utilisateur. Pour plus d'informations, veuillez consulter notre <a href="politique-cookies.php">politique de cookies</a>.</p>
            </div>
        </section>
    </main>
